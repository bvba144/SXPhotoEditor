#
#  Be sure to run `pod spec lint SXPhotoEditor.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source_files  = "SXPhotoEditor/Classes/**/*.{h,m}"
  ...
  spec.resources = ["SXPhotoEditor/Classes/common/LFMediaEditingController.bundle", "SXPhotoEditor/Classes/vendors/LFTipsGuideView/LFTipsGuideView.bundle", "SXPhotoEditor/Classes/vendors/LFEasyNoticeBar/LFEasyNoticeBar.bundle"]
