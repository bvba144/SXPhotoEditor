...
- (UIButton *)okBtn {
    if (!_okBtn) {
        ...
        NSString *btnName = [NSBundle LFME_localizedStringForKey:@"_LFME_userGuidOkImage"];
        [btn setImage:[NSBundle LF_tipGuideViewBundleImageNamed:btnName] forState:UIControlStateNormal];
        [btn sizeToFit];
